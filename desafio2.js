...
function exercicio1(){
    ...
    for (let i = 0; i < listaProdutos.length; i++) {
        let produto = listaProdutos[i]; // para numerar cada produto 
        // console.log (i + " " + produto.descricao); // para ver todos os produtos
...
// todos os produtos do estoque x preco / todas as quantidades
